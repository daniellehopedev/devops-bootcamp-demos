...
1. create a file, 'Dockerfile' in your project's root directory
    - sample file: https://github.com/daniellehopedev/devops-bootcamp-demos/blob/feature/containers-with-docker/module-7-demos/developing-with-docker/Dockerfile
